export default {
    ...
    cookieConsent: {
        ...
        description: 'Usamos cookies para melhorar sua experiência. Você pode escolher quais tipos de cookies aceitar.',
        essential: 'Essenciais',
        essentialDescription: 'Necessários para o funcionamento adequado do site',
        analytics: 'Analíticos',
        analyticsDescription: 'Nos ajudam a entender como você usa nosso site',
        marketing: 'Marketing',
